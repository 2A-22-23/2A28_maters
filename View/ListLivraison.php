...
$list = $livraisonC->listlivraisons();
?>
...
<div class="mx-auto bg-grey-lightest">
    ...
    <div class="min-h-screen flex flex-col">
                    ...
                    <li class="w-full h-full py-3 px-2 border-b border-light-border bg-white">
                        ...
                        <li class="w-full h-full py-3 px-2 border-b border-light-border bg-white">
                            ...
                            <li class="w-full h-full py-3 px-2 border-b border-light-border bg-white">
                                ...
                                <li class="w-full h-full py-3 px-2 border-b border-light-border bg-white">
                        <a href="Listlivreur.php" class="font-sans font-hairline hover:font-normal text-sm text-nav-item no-underline">
                            <i class="fab fa-wpforms float-left mx-2"></i>
                           check all delivery employees
                            <span><i class="fa fa-angle-right float-right"></i></span>
                        </a>
                    </li>
        ...
        ?>
            ...
            <tr>
                <td class="border px-4 py-2"><?= $livraison['id']; ?></td>
                <td class="border px-4 py-2"><?= $livraison['first_name']; ?></td>
           
                <td class="border px-4 py-2"><?= $livraison['phone_number']; ?></td>
                <td class="border px-4 py-2"><?= $livraison['postal_code']; ?></td>
                ...
                <td>
                    <a href="deleteLivraison.php?id=<?php echo $livraison['id']; ?>">Delete</a>
                </td>
            </tr>
        <?php
        }
        ?>    
                    ...
                    <div style="display: flex; align-items: center;  margin-left: 20px;">
                        <label for="Recherche">track delivery</label>
